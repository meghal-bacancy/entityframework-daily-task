...
{
    /// <inheritdoc />
    public partial class dataAdded6 : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "john@example.com", "John Doe" },
                    { 2, new DateTime(2023, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "jane@example.com", "Jane Smith" },
                    { 3, new DateTime(2023, 5, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "alice@example.com", "Alice Brown" },
                    { 4, new DateTime(2023, 7, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "bob@example.com", "Bob White" },
                    { 5, new DateTime(2023, 9, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "charlie@example.com", "Charlie Green" }
                });
